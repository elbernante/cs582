...
SIMILARITY_THRESHOLD = 0.7       # For filtering out similar images
...
TEST_SRC = os.path.join(DATA_DIR, "test")
...
TEST_SET_PICKLE = os.path.join(DATA_DIR, "test_set.npz")
...
HISTORY_LOG = os.path.join(OUTPUT_DIR, "history_log.pkl")
